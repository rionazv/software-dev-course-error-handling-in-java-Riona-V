...
public class Main {
    ...
    public static double safeDivision(double a, double b) {
        // DONE: Handle the unchecked ArithmeticException by returning 0.
    ...
    public static String getSecondLetter(String s, List<String> logMessages) {
        // DONE: Handle the StringIndexOutOfBoundsException by returning an empty string ("")
        ...
        try {
            ...
            // DONE: This line needs to happen after the try/catch block, regardless of whether an exception is thrown (put it in a finally block)
    ...
    public static double safeDivideWithCustomException(double a, double b) throws CustomDivideByZeroException {
        ...
        if (b == 0) throw new CustomDivideByZeroException(a, b);
        return divide(a, b);
    }
}
